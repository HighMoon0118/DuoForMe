        ...
        <div className="champion-box">
          {user.recomCham[0][0][0] === "null" ? <div className="null"></div> : 
            <div className="champion-info">
              ...
              <div className="champion-name">{user.recomCham[0][0][1]}</div>  
            </div>
          }
        </div>
        <div className="champion-box">
          {user.recomCham[0][1][0] === "null" ? <div className="null"></div> : 
            <div className="champion-info">
              ...
              <div className="champion-name">{user.recomCham[0][1][1]}</div>  
            </div>
          }
        </div>
        <div className="champion-box">
          {user.recomCham[0][2][0] === "null" ? <div className="null"></div> : 
            <div className="champion-info">
              ...
              <div className="champion-name">{user.recomCham[0][2][1]}</div>  
            </div>
          }
        </div>
      </div>
